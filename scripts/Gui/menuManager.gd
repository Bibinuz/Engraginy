...
@onready var grids = {
	BuildingCategory.MACHINE : productionGrid,
	BuildingCategory.POWER_NODE : energyGrid,
	BuildingCategory.GENERATOR : energyGrid,
	BuildingCategory.FUNDATIONS : fundationsGrid,
	BuildingCategory.DECORATION : decorationGrid
}
