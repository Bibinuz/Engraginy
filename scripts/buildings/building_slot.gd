...
@export var current_building: Resource = null
var slot_index: int

func ready():
	update_visuals()

func set_building(data: Resource) -> void:
...
func _get_drag_data(_position: Vector2) -> Resource:
...
func _can_drop_data(_position: Vector2, data: Variant) -> bool:
	return data is Resource and "scene" in data and not is_read_only
