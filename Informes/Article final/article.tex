...
\begin{figure}[!ht]
\centering
    \includegraphics[width=0.45\textwidth]{img/GameMenus.png}
    \caption{Mostra dels menus del joc}
    \label{fig:game-menus}
\end{figure}

En la Fig. \ref{fig:game-menus}, es mostra el menú de construcció, amb les seves quatre pestanyes diferents per organitzar els objectes, i la barra d'accés ràpid, omplerta amb una sèrie d'objectes. Per conf iguraraquesta barra es poden arrossegar les imatges del menú de construcció fins a la posició de la barra on ho volem vincular, aquesta barra conté nou caselles, cada una vinculada a les tecles 1-9 del teclat.
...
\centering
    ...
    \caption{Exemple del tres estats en el moment de construir un objecte}
